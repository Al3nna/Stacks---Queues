...
public class Queue {
    ...
    public void enQueue(Commission item) {
        //updating vars
        rear++;
        size++;
        //if node is first
        ...
        System.out.println("WWC recieved "+item.client+"'s commission. "+item+" has been enqueued to the queue.");
    }
    ...
    public Node deQueue() {
        ...
        //queue is not empty
            ...
            System.out.println(discarded.data.client+"'s commission has been completed. "+discarded.data+" has been dequeued from the queue.");
